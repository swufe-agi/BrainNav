...
class PromptManager(object):
    ...
    def requirements_and_thought(self):
        ...
        thought = """Your answer must be in JSON format with 'Thought', 'New Planning', and 'Action' fields.Note: For turn around and backtracking, prioritize backtracking.Choose the direction (left or right) to avoid the obstacle, if possible.
