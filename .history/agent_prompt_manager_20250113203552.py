...
class PromptManager(object):
    ...
    "Action": Select the letter of the next action from the 'Action options', ensuring it corresponds to a node in the 'road' field. Output only the action letter, such as Action: 'A'. When choosing Action: 'C', must prioritize selecting 'F' instead of 'C'."""
