...
class PromptManager(object):
    ...
    def make_image_prompt_json(self): 
        ...
        distance_to_obstacles = """Estimate the distance to the nearest obstacle (e.g., wall, large cardboard box) in each observed scene. 
                                ...
                                image5: "approximately 1 meter".；
                                image7: "less than 0.1 meter"."""        
    ...
    #                     Your task is to explore between locations marked with IDs and ultimately find the target location, stopping within 0.1 meters of it. 
    ...
    #     Trajectory = """'Trajectory' represents the ID info of the places you have explored. You start navigating from Place 0."""
    ...
    def task_description(self, t):
        ...
        """
        background = """You are an embodied robot that navigates in the real world. Your task is to explore between locations marked with IDs and ultimately find the target location, stopping within 0.1 meters of it.
                            At each step, you will receive images of the four candidate nodes (front, back, left, right) of your current node, showcasing the explored and observed locations. Provide a detailed description of what is in each image."""

        Instruction = """'Instruction' is a global guidance, and you need to carefully identify the commands that have not been executed yet, ensuring that the execution order and progress align with the predetermined plan."""
        ...
        history = 'The navigation has just started with no previous history.' if t == 0 else """'History' represents the places you have explored in previous steps along with their corresponding images. It may include the correct landmarks mentioned in the 'Instruction' as well as some past erroneous explorations."""
