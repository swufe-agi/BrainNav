...
def count_occurrences(file_path, target_phrase):
    # 打开文件并读取内容
...
# 示例调用
file_path = 'navigation_log.txt'  # 替换为你的文件路径
target_phrase = '开始执行指令'  # 替换为你要查找的词组

count = count_occurrences(file_path, target_phrase)
print(f"'{target_phrase}' 出现了 {count} 次")
