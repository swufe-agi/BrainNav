...
def gpt_infer(system, text, model="gpt-4", max_tokens=2000, response_format=None):
    """
...
def gpt_infer_with_item_list_and_check(file_path, instruction, system="任务指令与物品匹配查询", model="gpt-4", max_tokens=2000, response_format=None):
    """
