...
class PromptManager(object):
    ...
    def requirements_and_thought(self):
        ...
        thought = """Your answer must be in JSON format with 'Thought', 'New Planning', and 'Action' fields.When choosing Action: 'C', you must prioritize selecting 'F' instead of 'C'.
